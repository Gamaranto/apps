import { getTypeRegistry, bool, u16, u32, u64, Text, Option, Vec as Vector, GenericAccountId } from "@polkadot/types";
...
export class BlockchainTimestamp extends JoyStruct<BlockchainTimestampType> {
  constructor(registry: Registry, value?: BlockchainTimestampType) {
    super(
      registry,
      {
...
export class ModerationAction extends JoyStruct<ModerationActionType> {
  constructor(registry: Registry, value: ModerationActionType) {
    super(
      registry,
      {
        moderated_at: BlockchainTimestamp,
...
export class PostTextChange extends JoyStruct<PostTextChangeType> {
  constructor(registry: Registry, value: PostTextChangeType) {
    super(
      registry,
      {
        expired_at: BlockchainTimestamp,
...
export class ChildPositionInParentCategory extends JoyStruct<ChildPositionInParentCategoryType> {
  constructor(registry: Registry, value: ChildPositionInParentCategoryType) {
    super(
      registry,
      {
        parent_id: CategoryId,
...
export class Category extends JoyStruct<CategoryType> {
  constructor(registry: Registry, value: CategoryType) {
    super(
      registry,
      {
        id: CategoryId,
...
export class Thread extends JoyStruct<ThreadType> {
  constructor(registry: Registry, value: ThreadType) {
    super(
      registry,
      {
        id: ThreadId,
...
export class Reply extends JoyStruct<ReplyType> {
  constructor(registry: Registry, value: ReplyType) {
    super(
      registry,
      {
