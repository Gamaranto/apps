...
export class Slash extends JoyStruct<ISlash> {
  constructor(registry: Registry, value?: ISlash) {
    super(
      registry,
      {
...
export class UnstakingState extends JoyStruct<IUnstakingState> {
  constructor(registry: Registry, value?: IUnstakingState) {
    super(
      registry,
      {
        started_at_block: u32,
...
export class StakedState extends JoyStruct<IStakedState> {
  constructor(registry: Registry, value?: IStakedState) {
    super(
      registry,
      {
        staked_amount: u128,
...
export class Stake extends JoyStruct<IStake> {
  constructor(registry: Registry, value?: IStake) {
    super(
      registry,
      {
        created: u32,
