...
import { VideoPlayer, GenericSection, ChannelSummary, DetailsTable } from "@joystream/components";
...
function VideoViewComponent({ video, channel }: VideoViewProps) {
  return (
    <>
      ...
      <GenericSection topDivider title={video.title} className="video-details">
        <ChannelSummary
      ...
      <GenericSection topDivider title="Video details" className="video-details-table">
